  ...
  <i class="fas fa-plus"></i> Add Task
        ...
        <div class="add-task">
            ...
            <form @submit.prevent="addTask">
                ...
                <div class="btn-group">
                    <!-- زر الإلغاء -->
                    <button type="button" @click="showTaskForm = false" class="cancel-btn">
                        Cancel
                    </button>
...
export default {
    ...
    return {
      ...
      tasks: [
        { 
          ...
          description: 'Review and finalize the monthly report details.',
          priority: 'High', 
          due_date: '2025-04-20',
          is_completed: false,
          status: 'Pending'
        ...
        { 
          ...
          description: 'Participate in the meeting and share updates.', 
          priority: 'Medium', 
          due_date: '2025-04-21',
          is_completed: false,
          status: 'Completed'
        },
        {
          ...
          description: 'Prepare and send the new project proposal to the manager.',
          priority: 'High',
          due_date: '2025-04-22',
          is_completed: false,
          status: 'Pending'
        },
        {
          ...
          description: 'Update records for new client entries.',
          priority: 'Low',
          due_date: '2025-04-19',
          is_completed: true,
          status: 'Completed'
        },
        {
          ...
          description: 'Go through new job applicants and shortlist candidates.',
          priority: 'Medium',
          due_date: '2025-04-25',
          is_completed: false,
          status: 'Pending'
        },
        {
          ...
          description: 'Organize ideas for next month’s team-building event.',
          priority: 'Low',
          due_date: '2025-04-28',
          is_completed: true,
          status: 'Completed'
        },
        {
          ...
          description: 'Resolve known issues on the website.',
          priority: 'High',
          due_date: '2025-04-18',
          is_completed: false,
          status: 'Pending'
        },
        {
          ...
          description: 'Draft a plan for team tasks this week.',
          priority: 'Medium',
          due_date: '2025-04-17',
          is_completed: true,
          status: 'Completed'
        },
        {
          ...
          description: 'Make initial logo drafts for upcoming brand refresh.',
          priority: 'Low',
          due_date: '2025-04-22',
          is_completed: false,
          status: 'Pending'
        ...
        },
        {
          ...
          description: 'Follow up with supplier for delayed shipment.',
          priority: 'High',
          due_date: '2025-04-16',
          is_completed: false,
          status: 'Pending'
        },
        {
          ...
          description: 'Review, finalize, and publish article on company blog.',
          priority: 'Medium',
          due_date: '2025-04-20',
          is_completed: true,
          status: 'Completed'
        ...
        },
        {
          ...
          description: 'Talk to 3 users about their experience.',
          priority: 'Medium',
          due_date: '2025-04-24',
          is_completed: true,
          status: 'Completed'
        },
        {
          ...
          description: 'Export and analyze sales data from last month.',
          priority: 'High',
          due_date: '2025-04-19',
          is_completed: false,
          status: 'Pending'
        },
        {
          ...
          description: 'Ensure new feature works across all platforms.',
          priority: 'Medium',
          due_date: '2025-04-27',
          is_completed: true,
          status: 'Completed'
        },
        {
          ...
          description: 'Respond to customer feedback emails.',
          priority: 'Low',
          due_date: '2025-04-18',
          is_completed: false,
          status: 'Pending'
        },
        {
          ...
          description: 'Draft agenda for next week’s management meeting.',
          priority: 'Medium',
          due_date: '2025-04-26',
          is_completed: true,
          status: 'Completed'
        },
        {
          ...
          description: 'Run optimization script on production database.',
          priority: 'High',
          due_date: '2025-04-20',
          is_completed: false,
          status: 'Pending'
        },
        {
          ...
          description: 'Reorganize shared folders for better accessibility.',
          priority: 'Low',
          due_date: '2025-04-21',
          is_completed: true,
          status: 'Completed'
      ...
      newTaskPriority: 'Low',
      newTaskDueDate: '',
      // خاصية فلترة الحالة: القيمة الفارغة تعني عرض الكل
  ...
  computed: {
    userAvatar() {
      return `https://ui-avatars.com/api/?name=${encodeURIComponent(this.user.name)}&background=random`;
    },
    filteredTasks() {
  ...
  methods: {
    ...
    async completeTask(task) {
      ...
      try {
        ...
        // استعادة الحالة السابقة في حال فشل التحديث
